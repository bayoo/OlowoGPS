    ...
    extends MapProviderAdapter
{
    ...
    **/
        ...
        throws IOException 
    {
        ...
        JavaScriptTools.writeJSVar(out, "TEXT_INFO_ADDR"            , i18n.getString("JSMap.info.address"   , "Address"));
        JavaScriptTools.writeJSVar(out, "TEXT_DEVICE"               , i18n.getString("JSMap.device"         , "Device"));
        ...
        JavaScriptTools.writeJSVar(out, "TEXT_ADDR"                 , i18n.getString("JSMap.address"        , "Address"));
        ...
        throws IOException 
    {
        ...
        for (Iterator<String> k = iconMap.keyIterator(); k.hasNext();) {
            ...
            int     iX = ppi.getIconOffsetX();
            int     iY = ppi.getIconOffsetY();
    ...
    protected void writeJSIncludes(PrintWriter out, RequestProperties reqState, String jsMapURLs[]) 
        throws IOException 
    {
        JavaScriptTools.writeJSIncludes(out, jsMapURLs);
    }
    ...
    public void writeMapUpdate(RequestProperties reqState, int statusCodes[])
        throws IOException
    {
        super.writeMapUpdate(reqState, statusCodes);
    }
