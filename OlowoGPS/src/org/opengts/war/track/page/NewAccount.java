    ...
    implements Constants
{
        ...
        String name, String email, String auth)
    {
        ...
        byte acm[] = Base64.decode(privLabel.getStringProperty(PrivateLabel.PROP_NewAccount_authCodeMask,null));
    ...
    public static void main(String argv[])
    {
        ...
        /* auth mask */
        byte acm[] = Base64.decode(bpl.getStringProperty(PrivateLabel.PROP_NewAccount_authCodeMask,null));
        if (ListTools.isEmpty(acm)) {
