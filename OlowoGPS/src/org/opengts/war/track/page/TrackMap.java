    ...
    implements Constants
{
        ...
        throws IOException
    {
        ...
        if ((device != null) && (device.getDCServerConfig() != null)) {
            ...
            //Print.logInfo("Checked 'map' commands ..." + deviceSupportsPing);
        } else {
        ...
        HTMLOutput HTML_JS = new HTMLOutput() {
            public void write(PrintWriter out) throws IOException {
                ...
                TrackMap.this.writeJS_MapUpdate(reqState, out, 
                    ...
                    mapControlsOnLeft, showBatteryLevel
                    );
            }
        };
            ...
            public void write(PrintWriter out) throws IOException {
                ...
                if (TrackMap.this.getBooleanProperty(privLabel,PrivateLabel.PROP_TrackMap_enableGeocode,false)) {
                    ...
                    if (gcp.getName().startsWith("geonames")) {
                        ...
                        String i18nGotoBtn = i18n.getString("TrackMap.gotoAddress","Find Address");
