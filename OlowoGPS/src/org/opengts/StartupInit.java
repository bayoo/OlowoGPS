    ...
    implements DBConfig.DBInitialization, DBFactory.CustomFactoryHandler
{
    ...
    private String      PROP_OptionalEventFields_Device     = "OptionalEventFields.Device";
    private String      PROP_OptionalEventFields_EventData  = "OptionalEventFields.EventData";
    ...
    **/
    protected EventUtil.OptionalEventFields createOptionalEventFieldsHandler()
    {
        ...
        final DBField optDevFields[] = this.parseFields(Device.getFactory()   ,RTConfig.getStringArray(PROP_OptionalEventFields_Device   ,devFieldNames));

        /* get Device/Event fields */
        String evtFieldNames[] = null;
        final DBField optEvtFields[] = this.parseFields(EventData.getFactory(),RTConfig.getStringArray(PROP_OptionalEventFields_EventData,evtFieldNames));
                    ...
                    if (optDevFields != null) {
                        ...
                        if ((ndx < optDevFields.length) && (edp instanceof EventData)) {
                            ...
                            if (device != null) {
                                ...
                                if (fld.getName().equals(Device.FLD_linkURL)) {
                                    ...
                                    if (account != null) {
                                        val = account.convertFieldUnits(fld, val, true/*inclUnits*/, locale);
                                    }
    ...
    **/
    public java.util.List<DBField> selectFields(DBFactory factory, java.util.List<DBField> fields)
    {
        ...
        if (tblName.equalsIgnoreCase(Device.TABLE_NAME())) {
            ...
            addDBFields(tblName, fields, Device.OPTCOLS_MiscFieldInfo                   , false, Device.MiscFieldInfo);
