...
public class DCServerFactory
{
    ...
    public static final String  ARKNAV9_NAME                    = "arknav9";        // [3x335] R9
    ...
    public static final String  BIGWATCHER_NAME                 = "bigwatcher";     // [xxxxx] 3x370
    public static final String  MOREY_NAME                      = "morey";          // [xxxxx] 3x372
    public static final String  EWING_NAME                      = "ewing";          // [xxxxx] 3x374
    public static final String  GT95_NAME                       = "gt95";           // [xxxxx] 3x376
                                ...
                                if (cmdEnable) {
                                    ...
                                    if ((cmdPort > 0) || 
                                        ...
                                        dcs.addCommand(
                                            ...
                                            cmdProto, expectAck,
                                            cmdSCode);
                                        //Print.logInfo("Added command [" + dcs.getName() + "]: " + cmdName);
                                    } else {
                                        Print.logWarn("["+dcs.getName()+"] Command ignored (not an SMS protocol command): " + cmdName);
                                    }
                                } else {
                                    //Print.logInfo("Command disabled [" + dcs.getName() + "]: " + cmdName);
                                }
                            } else {
                                // unrecognized tag
                            }
    ...
    **/
    public static String[] CONFIG_MAX_HDOP(String name)
    {
        return new String[] { name + CFG_maximumHDOP };
    }
    ...
    *** @return An array of "Ignore Invalid GPS Flag" property names
    **/
    public static String[] CONFIG_IGNORE_INVALID_GPS_FLAG(String name)
    {
        return new String[] { name + CFG_ignoreInvalidGPSFlag };
    }
    ...
    *** @return An array of "Save Session Statistics" property names
    **/
    public static String[] CONFIG_SAVE_SESSION_STATISTICS(String name)
    {
        return new String[] { name + CFG_saveSessionStatistics };
    }
