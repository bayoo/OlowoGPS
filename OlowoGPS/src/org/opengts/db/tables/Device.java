    ...
    implements DataTransport
{
    ...
    public static final String  OPTCOLS_MiscFieldInfo               = "startupInit.Device.MiscFieldInfo";
  ...
  //public static final String FLD_smsGatewayProps       = "smsGatewayProps";       // SMS gateway properties
    ...
    private static DBField FieldInfo[] = {
      ...
      //new DBField(FLD_dcsConfigString      , String.class        , DBField.TYPE_STRING(64)  , I18N.getString(Device.class,"Device.fld.dcsConfigString"      , "DCS Configuration String"    ), "edit=2"),
        ...
        new DBField(FLD_lastBatteryLevel     , Double.TYPE         , DBField.TYPE_DOUBLE      , I18N.getString(Device.class,"Device.fld.lastBatteryLevel"     , "Last Battery Level"          ), "format=#0.0"),
        new DBField(FLD_lastFuelLevel        , Double.TYPE         , DBField.TYPE_DOUBLE      , I18N.getString(Device.class,"Device.fld.lastFuelLevel"        , "Last Fuel Level"             ), "format=#0.0"),
        ...
        new DBField(FLD_lastOdometerKM       , Double.TYPE         , DBField.TYPE_DOUBLE      , I18N.getString(Device.class,"Device.fld.lastOdometerKM"       , "Last Odometer km"            ), "format=#0.0"),
        new DBField(FLD_odometerOffsetKM     , Double.TYPE         , DBField.TYPE_DOUBLE      , I18N.getString(Device.class,"Device.fld.odometerOffsetKM"     , "Odometer Offset km"          ), "format=#0.0"),
  ...
  //public static final String FLD_workOrderID           = "workOrderID";           // WorkOrder ID (may not be used)
    ...
    **/
    ...
    public boolean sendDeviceCommand(String cmdType, String cmdName, String cmdArgs[])
    {
        ...
        /* PingDispatcher */
        if (Device.hasPingDispatcher()) {
            boolean sentOK = Device.getPingDispatcher().sendDeviceCommand(this, cmdType, cmdName, cmdArgs);
            return sentOK;
        } else {
            return false;
        }
    ...
    **/
    protected boolean _insertEventData(final EventData evdb)
    {
        ...
        if (!evdb.isValidGeoPoint() && evdb.canUpdateCellTowerLocation()) {
            CellTower dct = this.getLastServingCellTower();
            if (dct == null) {
                // No last CellID
            ...
            if (!dct.equals(evdb.getServingCellTower())) {
                ...
                if ((ml != null) && ml.isValid()) {
                    ...
                    Print.logInfo("Using cached CellTower location: n/a");
                }
            }
        }
