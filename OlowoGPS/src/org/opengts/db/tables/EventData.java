  ...
  //public static final String FLD_obdType              = "obdType";                // OBD type [0,1=J1708, 2=J1939, 3=OBDII]
    ...
    public static final DBField CANBUSFieldInfo[] = { 
      ...
      //new DBField(FLD_obdType          , Integer.TYPE  , DBField.TYPE_UINT16    , I18N.getString(EventData.class,"EventData.fld.obdType"            , "OBD Type"              ), ""),
        ...
        new DBField(FLD_fuelTemp         , Double.TYPE   , DBField.TYPE_DOUBLE    , I18N.getString(EventData.class,"EventData.fld.fuelTemp"           , "Fuel Temp"             ), "format=#0.00 unit=temp"),
        new DBField(FLD_fuelLevel        , Double.TYPE   , DBField.TYPE_DOUBLE    , I18N.getString(EventData.class,"EventData.fld.fuelLevel"          , "Fuel Level"            ), "format=#0.00 units=percent"),
        ...
        new DBField(FLD_transOilTemp     , Double.TYPE   , DBField.TYPE_DOUBLE    , I18N.getString(EventData.class,"EventData.fld.transOilTemp"       , "Transmission Oil Temp" ), "format=#0.00 unit=temp"),
    ...
    public static final String FLD_analog0              = "analoge0";               // 
    public static final String FLD_analog1              = "analoge1";               // 
    public static final String FLD_analog2              = "analoge2";               // 
    public static final String FLD_analog3              = "analoge3";               // 
    ...
    **/
    ...
    public void setInputMask(long v)
    {
        if (v < 0L) {
            ...
            // FLD_inputMask is currently 32-bit
    ...
    {
        Collection<CellTower> nct = null;
        for (int n = 0; n <= 5; n++) {
            CellTower ct = this.getNeighborCellTower(n);
            if (ct != null) {
                if (nct == null) { nct = new Vector<CellTower>(); }
                nct.add(ct);
            }
        }
        return (nct != null)? nct.toArray(new CellTower[nct.size()]) : null;
    }
    ...
    **/
        ...
        boolean isFleet, BasicPrivateLabel bpl)
    {
        ...
        if (!isFleet && this.getIsLastEvent()) {
            int iconNdx = EventData._getPushpinIconIndex("last", iconKeys, -1);
            if (iconNdx >= 0) { // '0' is a valid index
                if (DebugPushpins) Print.logInfo("Pushpin - 'last' index: " + iconNdx);
                return iconNdx;
            }
        }
