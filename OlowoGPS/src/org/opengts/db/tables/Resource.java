    ...
    extends AccountRecord<Resource>
{
    ...
    **/
    public static RTProperties getPrivateLabelPropertiesForHost(String hostName)
    {
        ...
        if (!StringTools.isBlank(hostName) && !StringTools.isBlank(sysAdminID)) {
            ...
            try {
                Resource res = Resource._getResource(sysAdminID, resKey);
                if (res != null) {
                    // Example properties:
                    ...
                    //Print.logInfo("Resource Key not found: " + sysAdminID + "/" + resKey);
                }
