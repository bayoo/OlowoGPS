    ...
    implements UserInformation
{
  ...
  //public static final String FLD_newUserRoleID            = "newUserRoleID";
    ...
    **/
    ...
    {
        try {
            AccountString str = AccountString.getAccountString(this, AccountString.ID_DEVICE);
            if (str != null) {
    ...
    {
        try {
            AccountString str = AccountString.getAccountString(this, AccountString.ID_DEVICE_GROUP);
            if (str != null) {
                String s = str.getSingularTitle();
                String p = str.getPluralTitle();
                if ((dft == null) && (dft.length >= 2)) {
    ...
    {
        try {
            AccountString str = AccountString.getAccountString(this, AccountString.ID_ENTITY);
            if (str != null) {
                return new String[] { str.getSingularTitle(), str.getPluralTitle() };
            }
        } catch (DBException dbe) {
            // ignore
        }
    ...
    **/
    public static String[] getAccountsForContactEmail(String emailAddr)
        throws DBException
    {
