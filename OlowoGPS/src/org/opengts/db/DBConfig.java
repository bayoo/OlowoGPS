...
public class DBConfig
{
    ...
    public  static final String PACKAGE_OPT                     = PACKAGE_OPENGTS_ + "opt";
    public  static final String PACKAGE_OPT_                    = PACKAGE_OPT      + ".";
    public  static final String PACKAGE_OPT_AUDIT_              = PACKAGE_OPT_     + "audit.";
    ...
    public  static final String PACKAGE_EXTRA_DBTOOLS_          = PACKAGE_EXTRA_   + "dbtools.";
    ...
    public  static final String PACKAGE_RULE_TABLES_            = PACKAGE_RULE_    + "tables.";
    ...
    public  static final String PACKAGE_BCROSS_TABLES_          = PACKAGE_BCROSS_  + "tables.";
    ...
    *** Type: DCServer name
    **/
    public static final String PROP_dcs_name                            = "dcs.name";

    /**
    *** Runtime Configuration Property<br>
    *** The default interface to which local device communication servers should bind.<br>
    *** Type: IP Address or Host name
    **/
    public static final String PROP_dcs_bindInterface                   = "dcs.bindInterface";

    /**
    *** Runtime Configuration Property<br>
    *** The default maximum backlog to allow for incoming connections.<br>
    *** Type: Integer
    **/
    public static final String PROP_dcs_listenBacklog                   = "dcs.listenBacklog";

    /**
    *** Runtime Configuration Property<br>
    *** The default port offset to apply to specified port numbers in the device communication server configuration files.<br>
    *** Type: Integer
    **/
    public static final String PROP_dcs_portOffset                      = "dcs.portOffset";
    ...
    protected static RTKey.Entry runtimeKeys[] = {
        ...
        new RTKey.Entry(PROP_dcs_name                           , ""                            , "Default DCS ame"),
        new RTKey.Entry(PROP_dcs_bindInterface                  , null                          , "DCS Local 'Bind' Address"),
        new RTKey.Entry(PROP_dcs_listenBacklog                  , -1                            , "DCS Listen Backlog"),
        new RTKey.Entry(PROP_dcs_portOffset                     , 1000                          , "DCS Port Offset"),
    };
