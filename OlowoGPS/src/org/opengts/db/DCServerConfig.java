    ...
    implements Comparable
{
  ...
  //public static final String  COMMAND_OUTPUT                  = "output";     // arg=gpioOutputState
    ...
    public void setTcpPorts(InetAddress bindAddr, int tcp[], boolean checkRTP)
    {
        if (checkRTP) {
            tcp = this._getServerPorts(
                ...
                DCServerFactory.CONFIG_TCP_PORT(this.getName()), 
                tcp);
        }
    ...
    public void setUdpPorts(InetAddress bindAddr, int udp[], boolean checkRTP)
    {
        if (checkRTP) {
            udp = this._getServerPorts(
                ...
                DCServerFactory.CONFIG_UDP_PORT(this.getName()), 
                udp);
        }
    ...
    **/
    ...
    {
        return this.getDoubleProperty(DCServerFactory.CONFIG_MAX_HDOP(this.getName()), dft);
    }
    ...
    **/
    ...
    {
        return this.getBooleanProperty(DCServerFactory.CONFIG_IGNORE_INVALID_GPS_FLAG(this.getName()), dft);
    }
    ...
    **/
    ...
    {
        return this.getBooleanProperty(DCServerFactory.CONFIG_SAVE_SESSION_STATISTICS(this.getName()), dft);
    }
    ...
    **/
    public void setCommandDispatcherPort(int cmdPort, boolean checkRTP)
    {
        if (checkRTP) {
            ...
            if (port <= 0) {
                port = this.getIntProperty(DCServerFactory.CONFIG_COMMAND_PORT(this.getName()), 0);
            }
