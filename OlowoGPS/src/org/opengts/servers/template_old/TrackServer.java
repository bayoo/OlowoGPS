...
public class TrackServer
{
    ...
    {
        String keys[] = DCServerFactory.CONFIG_TCP_IDLE_TIMEOUT(Constants.DEVICE_CODE);
    ...
    {
        String keys[] = DCServerFactory.CONFIG_TCP_PACKET_TIMEOUT(Constants.DEVICE_CODE);
    ...
    {
        String keys[] = DCServerFactory.CONFIG_TCP_SESSION_TIMEOUT(Constants.DEVICE_CODE);
    ...
    {
        String keys[] = DCServerFactory.CONFIG_UDP_IDLE_TIMEOUT(Constants.DEVICE_CODE);
    ...
    {
        String keys[] = DCServerFactory.CONFIG_UDP_PACKET_TIMEOUT(Constants.DEVICE_CODE);
    ...
    {
        String keys[] = DCServerFactory.CONFIG_UDP_SESSION_TIMEOUT(Constants.DEVICE_CODE);
