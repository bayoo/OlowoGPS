    ...
    extends AbstractClientPacketHandler
{
  ...
  //public static       boolean SIMEVENT_GEOZONES           = false;
    ...
    {
        return ServerSocketThread.PACKET_LEN_ASCII_LINE_TERMINATOR;
    }
    ...
    private boolean parseInsertRecord(String s)
    {
        ...
        if ((statusCode != StatusCodes.STATUS_LOCATION) || !validGPS) {
            this.insertEventRecord(device, fixtime, statusCode, geoPoint, 
                gpioInput, speedKPH, headingDeg, altitudeM, odomKM);
        } else
