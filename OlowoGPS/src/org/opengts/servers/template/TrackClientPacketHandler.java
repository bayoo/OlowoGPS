    ...
    extends AbstractClientPacketHandler
{
    ...
    public byte[] getHandlePacket(byte pktBytes[]) 
    {
        ...
        if ((pktBytes != null) && (pktBytes.length > 0)) {
            ...
            switch (DATA_FORMAT_OPTION) {
                ...
                case 3 : rtn = this.parseInsertRecord_ASCII_3(s); break;
    ...
    private byte[] parseInsertRecord_ASCII_1(String s)
    {
        ...
        // 0      1            2          3          4           5       6  
        // <IMEI>,<YYYY/MM/DD>,<HH:MM:SS>,<Latitude>,<Longitude>,<Speed>,<Heading>
        //   0 - IMEI unique ID
        //   1 - Date [GMT]
        //   2 - Time [GMT]
        //   3 - Latitude
    ...
    private byte[] parseInsertRecord_ASCII_2(String s)
    {
        ...
        Print.logInfo("//////////////////////// parse individual fields ///////////////////");
        Print.logInfo("\n");
        /* parse individual fields */
        ...
        Print.logInfo("\n\n /////////////// BAYO TEST Nmea0183 ////////////");
        Print.logInfo("Bayo's Test");
		String correctPacket = "bayo/gprmc_123456789012345/$GPRMC,080701.00,A,3128.7540,N,14257.6714,W,27.6,107.5,180607,13.1,E,A*2D";
		String gprmString = "bayo/gprmc_123456789012345/$GPRMC,080701.00,A,3128.7540,N,14257.6714,W,27.6,107.5,180607,13.1,E";
		int myCheckSum = Nmea0183.calcXORChecksum(correctPacket, true);
		int myCheckSum2 = Nmea0183.calcXORChecksum(gprmString, false);
		Print.logInfo("checkSum correctPacket = " + myCheckSum);
		Print.logInfo("checksum2 gprmString = " + myCheckSum2);

        Print.logInfo("//////////////////////// no deviceID ///////////////////");
        Print.logInfo("\n");
