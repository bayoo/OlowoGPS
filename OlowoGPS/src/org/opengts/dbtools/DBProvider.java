        ...
        throws SQLException, DBException
    {
        ...
        for (int i = 0; i < field.length; i++) {
            ...
            if ((existingColumns == null) || existingColumns.containsKey(xFldName)) {
                ...
                Print.logWarn("Field does not exist: " + xtableName + "." + fldName + " [ignored]");
            }
        }
        ...
        */
        ...
        if (addedField) {
            ...
            Print.logInfo("Nothing was inserted!!! [" + xtableName + "]");
    ...
    **/
        ...
        throws SQLException, DBException
    {
        ...
        if (addedField) {
            ...
            Print.logInfo("Nothing was updated!!! [" + xtableName + "]");
            return false;
        }
