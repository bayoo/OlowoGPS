...
public class DBField
{
        ...
        String charSet, Set<String> indexNames)
    {
        ...
        if (fact != null) {
            ...
            if (fld != null) {
                ...
                //Print.logInfo("This column is not used in the defined table: " + this.name);
        ...
        if ((akn != null) && (akn.length > 0)) {
            ...
            for (int i = 0; i < akn.length; i++) {
                ...
                if (akn[i].equalsIgnoreCase("true") || akn[i].equalsIgnoreCase("yes") || akn[i].equals("1")) {
                    ...
                    //Print.logInfo("Alternate Index: " + this.name + " ==> " + DBProvider.DEFAULT_ALT_INDEX_NAME);
                ...
                if (akn[i].equals(DBProvider.DEFAULT_ALT_INDEX_NAME)) {
                    ...
                    //Print.logInfo("Alternate Index: " + this.name + " ==> " + akn[i]);
    ...
    **/
    ...
    {
        return DBProvider.translateColumnName(this.name);
    }
