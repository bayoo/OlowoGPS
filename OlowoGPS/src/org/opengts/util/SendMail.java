...
public class SendMail
{
    ...
    public static final String SendMailArgs_class   = "org.opengts.util.SendMailArgs";
        ...
        implements Runnable
    {
        ...
        public void run() {
            if (this.args != null) {
                ...
                try {
                    MethodAction ma = new MethodAction(SendMailArgs_class, "send", Args.class);
    ...
    **/
    public static String getEMailAddress(String addr)
    {
        ...
        try {
            MethodAction ma = new MethodAction(SendMailArgs_class, "parseEMailAddress", String.class);
