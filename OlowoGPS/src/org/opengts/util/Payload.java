...
public class Payload
{
    ...
    **/
    public void readSkip(int length)
    {
        ...
        if (maxLen <= 0) {
            ...
            if (DebugLogging) { this.printDebug(1, maxLen, (byte[])null); }
            this.index += maxLen;
            return;
        }
    }
    ...
    **/
    public byte[] readBytes(int length)
    {
        ...
        if (maxLen <= 0) {
            ...
            if (DebugLogging) { this.printDebug(1, maxLen, n); }
            this.index += maxLen;
            return n;
        }
    }
    ...
    **/
    protected long _readLong(int length, long dft, boolean bigEndian, int frame)
    {
        int maxLen = this.getMaximumReadLength(length);
        ...
        if (maxLen <= 0) {
            ...
            if (DebugLogging) { this.printDebug(frame + 1, maxLen, bigEndian, true, val); }
            this.index += maxLen;
            return val;
        }
    }
    ...
    **/
    ...
    {
        return this._readLong(length, dft, bigEndian, 1);
    }
    ...
    **/
    ...
    {
        return this._readLong(length, dft, this.bigEndian, 1);
    }
    ...
    **/
    ...
    {
        return this._readLong(length, 0L, bigEndian, 1);
    }
    ...
    **/
    ...
    {
        return this._readLong(length, 0L, this.bigEndian, 1);
    }
    ...
    **/
    ...
    {
        return (int)this._readLong(length, (long)dft, this.bigEndian, 1);
    }
    ...
    **/
    ...
    {
        return (int)this._readLong(length, 0L, this.bigEndian, 1);
    }
    ...
    *** @return The decoded value, or the default value
    **/
    protected long _readULong(int length, long dft, boolean bigEndian, int frame)
    {
        int maxLen = this.getMaximumReadLength(length);
        Payload.checkOverflow(length, maxLen, frame + 1);
        if (maxLen <= 0) {
            ...
            if (DebugLogging) { this.printDebug(frame + 1, maxLen, bigEndian, false, val); }
            this.index += maxLen;
            return val;
        }
    }
    ...
    **/
    ...
    {
        return this._readULong(length, dft, bigEndian, 1);
    }
    ...
    **/
    ...
    {
        return this._readULong(length, dft, this.bigEndian, 1);
    }
    ...
    **/
    ...
    {
        return this._readULong(length, 0L, bigEndian, 1);
    }
    ...
    **/
    ...
    {
        return this._readULong(length, 0L, this.bigEndian, 1);
    }
    ...
    **/
    ...
    {
        return (int)this._readULong(length, (long)dft, bigEndian, 1);
    }
    ...
    **/
    ...
    {
        return (int)this._readULong(length, (long)dft, this.bigEndian, 1);
    }
    ...
    **/
    ...
    {
        return (int)this._readULong(length, 0L, bigEndian, 1);
    }
    ...
    **/
    ...
    {
        return (int)this._readULong(length, 0L, this.bigEndian, 1);
    }
    ...
    *** @return The decoded value, or the default value
    **/
    protected double _readDouble(int length, double dft, boolean bigEndian, int frame)
    {
        ...
        if (maxLen <= 0) {
            ...
            if (DebugLogging) { this.printDebug(frame + 1, maxLen, bigEndian, val); }
            this.index += maxLen;
            return val;
        }
    }
    ...
    **/
    ...
    {
        return this._readDouble(length, dft, bigEndian, 1);
    }
    ...
    **/
    ...
    {
        return this._readDouble(length, dft, this.bigEndian, 1);
    }
    ...
    **/
    ...
    {
        // 'length' must be at least 4
        return this._readDouble(length, 0.0, bigEndian, 1);
    }
    ...
    **/
    ...
    {
        // 'length' must be at least 4
        return this._readDouble(length, 0.0, this.bigEndian, 1);
    }
    ...
    **/
    protected String _readString(int length, boolean varLength, int frame)
    {
        ...
        if (maxLen <= 0) {
            ...
            if (DebugLogging) { this.printDebug(frame + 1, (varLength?(st+1):maxLen), str); }
            // move index
            if (varLength) {
                this.index += st;
    ...
    **/
    ...
    {
        return this._readString(length, varLength, 1/*frame*/);
    }
    ...
    **/
    ...
    {
        return this._readString(length, true, 1/*frame*/);
    }
    ...
    **/
    public GeoPoint readGPS(int length)
    {
        ...
        if (maxLen < 8) {
            ...
            if (DebugLogging) { this.printDebug(1, maxLen, gp); }
            this.index += maxLen; // 6
            return gp;
        } else {
            // 8 <= len
    ...
    **/
    ...
    /* debug */
    private void _printDebug(int frame, int maxLen, String valStr)
    {
        String frameStr = Print._getStackFrame(frame + 1);
    ...
    /* debug */
    private void printDebug(int frame, int maxLen, byte n[])
    {
        String valStr = "(bytes) 0x" + StringTools.toHexString(n);
        this._printDebug(frame + 1, maxLen, valStr);
    }

    /* debug */
    private void printDebug(int frame, int maxLen, boolean bigEndian, boolean signed, long val)
    {
    ...
    /* debug */
    private void printDebug(int frame, int maxLen, boolean bigEndian, double val)
    {
    ...
    /* debug */
    private void printDebug(int frame, int maxLen, String val)
    {
    ...
    /* debug */
    private void printDebug(int frame, int maxLen, GeoPoint val)
    {
