    ...
    **/
        ...
        throws DateParseException
    {
        ...
        if (dateGrp[0].length() == 0) {
            throw new DateParseException("Invalid Date/Time specification: " + dateStr);
        }
        ...
        if ((dateGrp[grpLen - 1].length() > 0) && Character.isLetter(dateGrp[grpLen - 1].charAt(0))) {
            ...
            if (timeZone == null) {
                throw new DateParseException("Invalid TimeZone: " + dateStr);
            }
            grpLen--;
        } else
        ...
        if (grpLen == 2) {
            ...
            if ((s == '+') || (s == '-')) {
                ...
                if (d.length != 3) {
                    throw new DateParseException("Invalid Date specification: " + dateStr);
                }
                for (String n : d) {
            ...
            if ((t.length < 1) || (t.length > 3)) {
                throw new DateParseException("Invalid Time specification: " + dateStr);
            }
            for (String n : t) {
                if (!StringTools.isInt(n,true)) {
                    throw new DateParseException("Invalid Time specification: " + dateStr);
