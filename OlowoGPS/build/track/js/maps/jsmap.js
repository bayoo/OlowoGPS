    ...
    //shadowURL, shadowSize)
{
    ...
    this.lat        = lat;
    this.lon        = lon;
    this.accRadM    = (this.evRcd != null)? evRcd.accuracy : 0;
    //if (this.accRadM > 0) { alert("JSMapPushpin: Accuracy Radius: " + this.accRadM); }
    ...
    this.iconOffset = ppIcon.iconOffset; //*/ iconOffset;
...
function jsmCreatePushPin(rcdNdx, dsNdx, ppNdx, evRcd)
{
    ...
    return new JSMapPushpin(
        ...
        dev, html, 
        ppi);
        //ppi.iconURL, ppi.iconSize, ppi.iconOffset, 
...
{ // required function 
    jsMapInit();
    jsmParseXMLPoints(xmlText, jsmRecenterZoomMode(RECENTER_ZOOM), 0);
};
