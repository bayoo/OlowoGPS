...
<head>
  ...
  <style type="text/css">
    ...
    TD.titleText {
        ...
        background: #DBDEEB url('./images/header_green_orange_900.jpg') center no-repeat;
...
<tbody>
  ...
  <tr>
  <td width="100%">
    <table class="bannerTable" width="900" border="0" cellpadding="0" cellspacing="0" align="center">
    <tbody>
    <tr>

      <gts:var>
      <td width="900" height="145" class="titleText" halign="center">
        <!-- 
			${pageTitle}<br>
        	<font style="font-size: 9pt;"><i>(Powered by <a href="http://www.opengts.org" target="_blank" style="color:#444444;">OpenGTS</a>)</i></font>
        -->

          <table align="right" width="590" height="100" valign="bottom" style="table-layout:fixed; margin-right:3">
             <tbody>
             <tr>
                <td valign="bottom" align="center"><a href="home.html"><font style="font-weight:bold; font-size:12pt; color:#FFFFFF;">Home </a></font> </td> 
                <td valign="bottom" align="center"><a href="aboutUs.html"><font style="font-weight:bold; font-size:12pt; color:#FFFFFF;">About Us </font></td> 
                <td valign="bottom" align="center"><a href="service.html"><font style="font-weight:bold; font-size:12pt; color:#FFFFFF;">Service </font></td> 
                <td valign="bottom" align="center"><a href="http://localhost:8080/track/Track?page=login"><font style="font-weight:bold; font-size:12pt; color:#FFFFFF;">Login </font></td>
                <td valign="bottom" align="center"><a href="contact.html"><font style="font-weight:bold; font-size:12pt; color:#FFFFFF;">Contact </font></td>
             </tr>
             </tbody>
		  </table>
	  </td>
  ...
  <td align="center">
     ...
     <tbody>
     <tr style="background: #333 url('./images/reflect-890.png') center no-repeat;">
  ...
  <tr height="100%">
  <td>
    <table width="900" height="100%" border="0" cellpadding="0" cellspacing="0" align="center" style="background: #fff url('./images/mainbox-900-900_no_bottom.png') no-repeat;">
    <tbody>
  ...
  <!-- Begin Page footer ======================================== -->
  <tr>
   <td style="background: #333 url('./images/mainbox-bottom.png') center no-repeat;">&nbsp;</td>
  </tr>
  <tr>
  <td>
